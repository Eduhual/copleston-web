...
for f in html_files:
    ...
    # We want to insert the social block right after the div closing the footer-brand. 
    # The structure is: 
    # <div class="footer-brand">
    #     <h2 class="footer-logo">...</h2>
    #     <p class="footer-motto">...</p>
    # </div>
    # <div class="footer-social"> ... </div>  <- THIS IS WHERE WE INSERT IT
    # <div class="footer-links">
    
    # Let's find exactly the spot before <div class="footer-links">
    
    new_content = re.sub(r'(\s*</div>\s*)(<div class="footer-links">)', rf'\1{replacement}\n            \2', content, count=1)
    ...
    if new_content != content:
        ...
        print(f"No changes made to {f} (maybe already modified or structure different)")
